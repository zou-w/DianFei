...
public class BeizhuData {
    ...
    @ExcelProperty({"电表"})
    private String db;
    @ExcelProperty(value = {"起度"}, converter = SafeDoubleConverter.class)
    private Double qd;
    @ExcelProperty(value = {"止度"}, converter = SafeDoubleConverter.class)
    private Double zd;
    @ExcelProperty({"开始时间"})
    private String kssj;
    @ExcelProperty({"结束时间"})
    ...
    @ExcelProperty({"支付时间"})
    private String zfsj;
    @ExcelProperty(value = {"支付电量"}, converter = SafeDoubleConverter.class)
    private Double zfdl;
    @ExcelProperty(value = {"用电金额"}, converter = SafeDoubleConverter.class)
    private Double ydje;
    @ExcelProperty({"供电方式"})
    private String gdfs;
    @ExcelProperty(value = {"应收电费"}, converter = SafeDoubleConverter.class)
    private Double ysdf;
    @ExcelProperty(value = {"分摊比例"}, converter = SafeDoubleConverter.class)
    private Double ftbl;
    @ExcelProperty(value = {"分摊金额"}, converter = SafeDoubleConverter.class)
    private Double ftje;
    @ExcelProperty({"备注"})
    private String bz;
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof BeizhuData)) {
            return false;
        } else {
            BeizhuData other = (BeizhuData)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BeizhuData;
    }
