...
public class TempBeizhuData2 {
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            return true;
        } else if (!(o instanceof TempBeizhuData2)) {
            return false;
        } else {
            TempBeizhuData2 other = (TempBeizhuData2)o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TempBeizhuData2;
    }
